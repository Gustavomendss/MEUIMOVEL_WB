"""
Django settings for MEUIMOVEL_WEB project.
...
SECRET_KEY = 'django-insecure-7s+1@tg-1ucjv@s!6_v&hdou4%pe@-6xujb=o%lah3lg)*luov'
...
ROOT_URLCONF = 'MEUIMOVEL_WEB.urls'
...
WSGI_APPLICATION = 'MEUIMOVEL_WEB.wsgi.application'
